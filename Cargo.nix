...
rec {
  ...
  rootCrate = rec {
    packageId = "asteroidssssssssssssssss";
  ...
  internal = rec {
    ...
    crates = {
      "asteroidssssssssssssssss" = rec {
        crateName = "asteroidssssssssssssssss";
        version = "0.1.0";
        edition = "2024";
        crateBin = [
          {
            name = "asteroidssssssssssssssss";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
      ...
      "sdl3" = rec {
        ...
        version = "0.17.3";
        edition = "2021";
        sha256 = "1ia91d52naz57cz9lj2xmigzpl3lf7w3jmcfjqg91xz7xly6kq6w";
        libPath = "src/sdl3/lib.rs";
        authors = [
        ...
        features = {
          ...
          "build-from-source" = [ "sdl3-sys/build-from-source" "sdl3-image-sys?/build-from-source" "sdl3-ttf-sys?/build-from-source" ];
          "build-from-source-static" = [ "sdl3-sys/build-from-source-static" "sdl3-image-sys?/build-from-source-static" "sdl3-ttf-sys?/build-static-vendored" ];
      ...
      "sdl3-sys" = rec {
        ...
        edition = "2024";
        links = "SDL3";
        sha256 = "0xql1mj5xf6fyx1cplgw6m7wm8cxxjcvgrvxap89nsqb1f1gqwqx";
        libName = "sdl3_sys";
        authors = [
          "Maia S Ravn <maia.noreply@runbox.com>"
        ];
        features = {
          "build-from-source" = [ "dep:cc" "dep:cmake" "dep:rpkg-config" "dep:sdl3-src" ];
        ...
        resolvedDefaultFeatures = [ "default" "metadata" "no-link" "only-metadata" ];
      };
    };
